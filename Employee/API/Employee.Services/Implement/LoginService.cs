...
namespace Employee.Services.Implement
{
    ...
    {
        private readonly IRepository<EmployeeEntity> _loginRepo;
        private readonly IConfiguration _configuration;

        public LoginService(IUnitOfWork unitOfWork, IRepository<EmployeeEntity> loginRepo, IConfiguration configuration) : base(unitOfWork)
        {
